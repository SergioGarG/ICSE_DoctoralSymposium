...
In this PhD project, we aim to produce a set of processes and architectural models and methods to be used by developers in order to improve reusability and modularity in robotic applications and also reducing the time wasting tasks.
In order to validate our results we make use of a set of service robots that will be employed for different case studies.
\end{abstract}
